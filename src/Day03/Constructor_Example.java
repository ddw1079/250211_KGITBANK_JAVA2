        ...
        while(select!=0) {
            ...
            switch (scInt) {
                ...
                case 1:
                    ...
                    System.out.print(index + "번에 에어컨을 추가합니다.");
                ...
                case 2:
                    ...
                    System.out.println((scInt-1) + ", "+ aircon[scInt-1].getAirconName() + " 의 에어컨을 설정합니다.");
                    System.out.print("설정할 에어컨 온도: ");
                    scInt = sc.nextInt();
                    if (18 <= scInt && scInt <= 30) {
                        aircon[scInt-1].setTemper(scInt);
                    }
                    System.out.print("설정할 에어컨 세기: ");
                    scInt = sc.nextInt();
                    if (1 <= scInt && scInt <= 3) {
                        aircon[scInt-1].setWind(scInt);
                    }
                    System.out.println();
                    System.out.print("");
                    break;
